...
public class HeatmapGUI : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        //controller.settings.pathForReadingData = Application.persistentDataPath + "/heatmap.txt";
        ...
        GUILayout.Label("\nSphereGO", EditorStyles.boldLabel);

        GUILayout.Label("Use only the one from package(or be creative if you know what you are doing)");

        controller.settings.spherePrefab = (GameObject)EditorGUILayout.ObjectField(controller.settings.spherePrefab, typeof(GameObject), true);
